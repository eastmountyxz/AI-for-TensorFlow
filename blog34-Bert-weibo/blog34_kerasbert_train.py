...
if __name__ == '__main__':
    ...
    #数据预处理
    train_df = pd.read_csv("data/p_weibo_3_moods_train.csv").fillna(value="")
    test_df = pd.read_csv("data/p_weibo_3_moods_test.csv").fillna(value="")
    ...
    print(len(train_D), len(test_D)) #26131 12171
